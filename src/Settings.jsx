...
export default function SettingsPage() {
  ...
  const payoutExplain = useMemo(() => {
    const v = Math.max(1, toInt(s.viewsPerDollar, 1000));
  ...
  const onSave = async () => {
    ...
    const normalized = {
      ...
      viewsPerDollar: Math.max(1, toInt(s.viewsPerDollar, 1000)),
      maxPayPerVideoUsd: Math.max(0, toMoney(s.maxPayPerVideoUsd, 0)),
      minViewCountEligibility: Math.max(0, toInt(s.minViewCountEligibility, 0)),
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, position: "relative", zIndex: 3 }}>
        ...
        >
          <div style={{ display: "flex", alignItems: "baseline", gap: 12 }}>
            ...
            <span style={{ fontSize: 13, opacity: 0.7 }}>
              Branding, payouts, and integrations
            </span>
          </div>
        ...
        {/* One clean container (like Clippers list) */}
        <div
          style={{
            borderRadius: 18,
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "baseline", gap: 10 }}>
            ...
            <div style={{ fontSize: 12, opacity: 0.65 }}>
              Controls header + watermark text
            </div>
          </div>
          ...
          {/* SECTION: Configure Payouts */}
          <div style={{ display: "flex", alignItems: "baseline", gap: 10 }}>
            <div style={{ fontSize: 16, fontWeight: 700 }}>Configure Payouts</div>
            <div style={{ fontSize: 12, opacity: 0.65 }}>
              Define earnings rules for clippers
            </div>
          </div>
            ...
            >
              ...
              >
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setS((p) => ({ ...p, viewsPerDollar: e.target.value }))
                  }
                  placeholder="1000"
                />
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <Toggle
                on={s.maxPayEnabled}
                setOn={(fn) =>
                  setS((p) => ({ ...p, maxPayEnabled: fn(p.maxPayEnabled) }))
                }
              />
              <div>
            ...
            <div>
              <Input
                ...
                onChange={(e) =>
                  setS((p) => ({ ...p, maxPayPerVideoUsd: e.target.value }))
                }
                placeholder="200"
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <Toggle
                ...
                setOn={(fn) =>
                  setS((p) => ({ ...p, minViewsEnabled: fn(p.minViewsEnabled) }))
                }
              />
              <div>
                <div style={{ fontWeight: 700 }}>Min View Count Eligibility</div>
                <div style={{ fontSize: 12, opacity: 0.65 }}>
                  Require minimum views to get paid
                </div>
              </div>
            </div>
            ...
            <div>
              <Input
                ...
                onChange={(e) =>
                  setS((p) => ({
                    ...p,
                    minViewCountEligibility: e.target.value,
                  }))
                }
                placeholder="50000"
          ...
          >
            ...
            <div>
              <Input
                ...
                onChange={(e) =>
                  setS((p) => ({ ...p, monthlyRetainerUsd: e.target.value }))
                }
                placeholder="0"
